...
fig, ax_spectrum = plt.subplots(figsize=(5, 4))
...
d2s = np.linspace(-15e-6, -15e-6, 1) + delta_quadratic_compensation
...
for d2 in tqdm(d2s):
    ...
    ax_spectrum.plot(freqs, spectrum, label='{:.1f}'.format((d2 - delta_quadratic_compensation)*1e6))
